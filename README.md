...
<p>
  <a href="https://skillicons.dev">
     <img src="https://skillicons.dev/icons?i=java,spring,maven,nodejs,ts,nest,python,fastapi,angular,postgres,mongodb,redis,linux,git,docker,kubernetes,terraform,rabbitmq,gitlab" />
